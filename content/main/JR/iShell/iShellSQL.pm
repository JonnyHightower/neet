...
# JR::iShell::iShellSQL.pm

# This is a quick hack of the proper iShell.pm module to make iShellSQL
# work without doing all the connector discovery stuff. The iShell framework
# will continue to function independently of this hack.

# Jonathan Roach

# iShell provides an interactive shell object for execution vectors that are not
...
sub new {
	...
	{
	  eval {
			use JR::iShell::ConnectorNativeMSSQL;
	  };
	  if ($@){
